...
<head>
  ...
  <!-- Material Icons — required by Angular Material's <mat-icon> in the admin panel -->
  ...
  <!-- Google tag (gtag.js) -->
  <script async="" src="https://www.googletagmanager.com/gtag/js?id=AW-18393228592"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'AW-18393228592');
  </script>

  <!--
    Google Ads conversion snippets.

    Google hands out the same function name (gtag_report_conversion) for every
    conversion action, so pasting two verbatim would leave the second silently
    overwriting the first. They are named per conversion here instead.
  -->

  <!-- Event snippet for WhatsApp Enquiry conversion -->
  <script>
    function gtag_report_whatsapp_conversion(url) {
      ...
      gtag('event', 'conversion', {
          'send_to': 'AW-18393228592/0XSFCN-g6eQcELDKycJE',
          'value': 1.0,
          'currency': 'INR',
  ...
  <!--
    ...
    This replaces the earlier "Website Phone Call" action
    (AW-18393228592/-_HqCNC97-QcELDKycJE), which tracked the same tel: links.
    Firing both would count every phone tap twice.
  -->
  <script>
    function gtag_report_call_conversion(url) {
      ...
      gtag('event', 'conversion', {
          'send_to': 'AW-18393228592/HivlCIvZ_-QcELDKycJE',
          'value': 1.0,
          'currency': 'INR',
          'event_callback': callback
      });
...
<link rel="stylesheet" href="styles-RIUWCOFL.css"></head>
<body><script type="text/javascript" id="ng-event-dispatch-contract">(()=>{function p(t,n,r,o,e,i,f,m){return{eventType:t,event:n,targetElement:r,eic:o,timeStamp:e,eia:i,eirp:f,eiack:m}}function u(t){let n=[],r=e=>{n.push(e)};return{c:t,q:n,et:[],etc:[],d:r,h:e=>{r(p(e.type,e,e.target,t,Date.now()))}}}function s(t,n,r){for(let o=0;o<n.length;o++){let e=n[o];(r?t.etc:t.et).push(e),t.c.addEventListener(e,t.h,r)}}function c(t,n,r,o,e=window){let i=u(t);e._ejsas||(e._ejsas={}),e._ejsas[n]=i,s(i,r),s(i,o,!0)}window.__jsaction_bootstrap=c;})();
</script>
  <app-root></app-root>
<link rel="modulepreload" href="chunk-W34XKJ77.js"><link rel="modulepreload" href="chunk-CCA3CVRB.js"><link rel="modulepreload" href="chunk-A4C3I7DD.js"><link rel="modulepreload" href="chunk-RLMZ4O46.js"><link rel="modulepreload" href="chunk-VC3SZG7Y.js"><script src="main-LIDHSXIR.js" type="module"></script></body>
</html>
`;